...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        /*else{
            Toast.makeText(MainActivity.this, "Email authentication went wrong", Toast.LENGTH_SHORT).show();
        }*/
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // display a error message to the user if sign in fails.
                            Toast.makeText(MainActivity.this, "Email authentication went wrong", Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
    ...
    /**
     * on starting the application, this checks to see if the user is already logged in and updates the UI
     * with the users data
     */
    @Override
    public void onStart() {
    ...
    private void updateUI(FirebaseUser currentUser) {
        if (currentUser != null){
            Intent intent = new Intent (MainActivity.this, DiaryEntries.class);
